...
function selectCountry(index) {
    ...
    for (let i = 0; i < addrWrap.getElementsByTagName('li').length; i++) {
        if (index == i) {
            addrWrap.getElementsByTagName('li')[i].style.backgroundColor = '#23B7E5';
        } else {
            addrWrap.getElementsByTagName('li')[i].style.backgroundColor = 'transparent';
        }
    }
...
document.getElementById('addr-show02').onclick = function (e) {
    $('#addr').toggle();
    // 阻止事件冒泡
